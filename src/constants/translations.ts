  ...
  RU: {
    ...
    greetingVariantsMorning: {
      ...
      unhinged: [
        ...
        'Утро. Бюджет вырос. На двести рублей.',
        ...
        'Утро. ПТС — дубликат. «Так получилось».',
        ...
        'Утро. ЦБ поднял ставку. Кредит вспомнил.',
        'УТРО. «РОДНОЙ КУЗОВ». ОТ ДВУХ МАШИН.',
        'Доброе утро. «Звоните в любое время». Не берёт.',
        'Утро. «Без пробега по РФ». Только по двору.',
    ...
    greetingVariantsAfternoon: {
      ...
      unhinged: [
        ...
        'Обед. «Свежепригнан из Кореи». Из Калуги.',
        ...
        'Полдень. Сравниваешь с Авито. Знаем.',
        ...
        'День. Сравниваешь с дром. Тот же ад.',
        ...
        'Полдень. ДПС на повороте. Скажут «здравствуйте».',
  ...
  EN: {
    ...
    greetingVariantsMorning: {
      ...
      unhinged: [
        ...
        'Morning. Budget up. By eight bucks.',
        ...
        'Morning. "Never driven in the country." Just around the yard.',
    ...
    greetingVariantsAfternoon: {
      ...
      unhinged: [
        ...
        'Lunch. "Fresh import from Korea." From down the road.',
    ...
    greetingVariantsEvening: {
      ...
      unhinged: [
        ...
        'Evening. "Car is just outside the city." In a different city.',
