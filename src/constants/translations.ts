export const TRANSLATIONS = {
  RU: {
    ...
    greetingVariantsMorning: {
      ...
      unhinged: [
        'УТРО! МОТОРЫ ПРОБУЖДАЮТСЯ!',
        'Солнце. Бензин. Судьба.',
        'Рассвет ревёт октанами!',
        'Поршни поют гимн дня!',
        'АВТОЭПОПЕЯ НАЧИНАЕТСЯ!',
        'Заря. Колёса трепещут.',
        'Утро. Карбюраторы воют.',
        'Восход! Аромат масла!',
        'Двигатели зовут зарю!',
        'ПРОСНИСЬ, ЛЕГЕНДА АСФАЛЬТА!',
      ],
    },
    greetingVariantsAfternoon: {
      ...
      unhinged: [
        'ПОЛДЕНЬ! МОТОРЫ ГРЕЮТ КРОВЬ!',
        'Солнце в зените. Шины дрожат.',
        'День! Эпос продолжается!',
        'Полдень — арена железа!',
        'Двигатели поют псалом дня!',
        'АСФАЛЬТ ЖАЖДЕТ СВЕРШЕНИЙ!',
        'День. Бензиновая симфония.',
        'Полдень. Шины громыхают!',
        'КОЛЁСА ВОПИЮТ К НЕБЕСАМ!',
        'Полудённый рёв стартеров!',
      ],
    },
    greetingVariantsEvening: {
      ...
      unhinged: [
        'ЗАКАТ! ФАРЫ ЗАЖИГАЮТСЯ!',
        'Сумерки. Моторы шепчут.',
        'Ночь близка. Колёса ждут.',
        'Вечерний гимн карданов!',
        'ЛУНА И ВЫХЛОПНЫЕ ТРУБЫ!',
        'Закат. Эпос не утихает.',
        'Тьма. Фары как маяки!',
        'Вечер — час железных снов!',
        'Полная луна! Полный бак!',
        'НОЧЬ ПРИЗЫВАЕТ ВОДИТЕЛЕЙ!',
      ],
    },
    headlineVariants: {
      wholesome: [
      ...
      unhinged: [
        'КАЖДОЕ АВТО — ОТДЕЛЬНАЯ САГА!',
        'Колёса. Судьбы. Бензин.',
        'Эпопея четырёх колёс грядёт!',
        'Гимн моторов гремит над миром!',
        'Тысячи машин. Один герой — ты.',
        'ЖЕЛЕЗНЫЕ КОНИ ВЗДЫМАЮТСЯ!',
        'Каждый поршень — это поэма.',
        'Дороги зовут. Карбюраторы вторят.',
        'Сага октанов разворачивается!',
        'АСФАЛЬТ ПОЁТ! МОТОРЫ ОТВЕЧАЮТ!',
      ],
    },
  ...
  EN: {
    ...
    greetingVariantsMorning: {
      ...
      unhinged: [
        'DAWN! ENGINES AWAKEN!',
        'Sunrise. Pistons sing.',
        'BEHOLD THE MORNING OF MOTORS!',
        'Daybreak. Tires tremble.',
        'MORNING ROARS IN OCTANE!',
        'Sun rises. So do dealers.',
        'Hear the carburetors chant!',
        'DAWN! WHEELS AWAIT GLORY!',
        'Morning. The asphalt calls.',
        'Behold! The age of horsepower!',
      ],
    },
    greetingVariantsAfternoon: {
      wholesome: [
      ...
      unhinged: [
        'NOON! THE ENGINES BLAZE!',
        'Midday. Steel sings.',
        'BEHOLD THE NOONDAY ROAR!',
        'Sun at peak. Pistons too.',
        'Afternoon! Glory in chrome!',
        'MIDDAY! TIRES THUNDER!',
        'Noon. The asphalt hums.',
        'Hear the engines cry out!',
        'The lot is alive at noon!',
        'MIDDAY EPIC OF MOTORS!',
      ],
    },
    greetingVariantsEvening: {
      wholesome: [
      ...
      unhinged: [
        'DUSK! HEADLIGHTS BLAZE!',
        'Twilight. Engines whisper.',
        'NIGHT FALLS! WHEELS RISE!',
        'Sundown. The chrome glows.',
        'Moonlight. Exhaust pipes sing!',
        'EVENING! THE SAGA BURNS ON!',
        'Night. Pistons keep vigil.',
        'Behold! The hour of horsepower!',
        'Dusk roars in eight cylinders!',
        'DARKNESS CALLS THE DRIVERS!',
      ],
    },
    headlineVariants: {
      wholesome: [
      ...
      unhinged: [
        'EVERY CAR IS A LEGEND!',
        'Steel. Fate. Petrol.',
        'The saga of four wheels begins!',
        'Behold the carburetor opera!',
        'A THOUSAND CARS! ONE HERO!',
        'Engines howl at the horizon!',
        'Each piston, a stanza.',
        'The asphalt sings your name!',
        'AN EPIC OF HORSEPOWER AWAITS!',
        'Roads thunder. Pistons reply.',
      ],
    },
