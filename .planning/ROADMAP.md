...
**Plans**: 11 plans
  ...
  - [x] 06-08-PLAN.md — Mount UserStatusBanner in App.tsx + Android LayoutAnimation enable (AFF-01)
  - [x] 06-09-PLAN.md — Jest literal scanner for new moderation components (QUAL-01)
  - [~] 06-0a-PLAN.md — Backend seed 10k users + verify-indexes.sh (cross-repo) (QUAL-02) — DEFERRED by operator 2026-04-19
  - [~] 06-0b-PLAN.md — Backend k6 harness with P95<200ms threshold + .gitignore (cross-repo) (QUAL-02) — DEFERRED by operator 2026-04-19
  - [x] 06-10-PLAN.md — Security review artifact 06-SECURITY.md (5 sections a-e) (QUAL-03)
**UI hint**: yes
...
| 6. Affected-User UX + Security Review (Both) | 10/12 | In Progress (mobile scope 10/10 complete; 06-0a/06-0b QUAL-02 operator-deferred 2026-04-19) | - |
